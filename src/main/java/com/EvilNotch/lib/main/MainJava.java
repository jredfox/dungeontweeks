...
import com.EvilNotch.lib.content.CmdSpawn;
...
@Mod(modid = MainJava.MODID,name = "Evil Notch Lib", version = MainJava.VERSION,acceptableRemoteVersions = "*")
public class MainJava {
	...
	public void preinit(FMLPreInitializationEvent e)
	{
    	...
    	GeneralRegistry.registerCommand(new CmdSpawn());
	}
	@Mod.EventHandler
